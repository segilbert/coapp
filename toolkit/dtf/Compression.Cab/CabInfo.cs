...
namespace Microsoft.Deployment.Compression.Cab
{
    ...
    /// </remarks>
    [Serializable]
    internal class CabInfo : ArchiveInfo
    {
        /// <summary>
        ...
        internal CabInfo(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        internal new IList<CabFileInfo> GetFiles()
        {
        ...
        internal new IList<CabFileInfo> GetFiles(string searchPattern)
        {
