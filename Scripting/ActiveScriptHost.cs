...
namespace CoApp.Toolkit.Scripting {
    ...
    public enum ScriptLanguage { JScript, VBScript };
    ...
    public interface IDispatch {
        ...
        [PreserveSig]
        int Invoke(int dispIdMember, ref Guid riid, int lcid, ushort wFlags, out ComTypes.DISPPARAMS pDispParams, out object varResult, out ComTypes.EXCEPINFO pExcepInfo, out int puArgErr);
    ...
    public interface IActiveScriptError {
        void GetExceptionInfo(out ComTypes.EXCEPINFO excepinfo);
    ...
    interface IActiveScript {
        ...
        void InterruptScriptThread(uint id, ref ComTypes.EXCEPINFO info, uint flags);
    ...
    interface IActiveScriptParse {
        void InitNew();
        void AddScriptlet(string defaultName, string code, string itemName, string subItemName, string eventName, string delimiter, uint sourceContextCookie, uint startingLineNumber, uint flags, out string name, out ComTypes.EXCEPINFO info);
        void ParseScriptText(string code, string itemName, IntPtr context, string delimiter, uint sourceContextCookie, uint startingLineNumber, uint flags, IntPtr result, out ComTypes.EXCEPINFO info);
    }
    ...
    interface IActiveScriptSite {
        ...
        void OnScriptTerminate(ref object result, ref ComTypes.EXCEPINFO info);
    ...
    public class ActiveScriptHost :IActiveScriptSite, IDisposable {
        ...
        private IActiveScript ActiveScript { get { return (scriptEngine as IActiveScript); } }
        private IActiveScriptParse ActiveScriptParse { get { return (scriptEngine as IActiveScriptParse); } }
        ...
        public void Invoke(string functionName, params object[] args ) {
            ...
            t.InvokeMember(functionName, System.Reflection.BindingFlags.InvokeMethod, null, dispatch, args);
        }

        public void GetLCID(out uint id) { id = 0x80004001; }
        ...
        public void GetDocVersionString(out string v) { v = "ScriptHost Version 1"; }
