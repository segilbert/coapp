...
namespace CoApp.Toolkit.Win32 {
    ...
    public class PEInfo {
        ...
        public ulong FileVersionLong { get { return _fileVersionLong.Value; }}
        public string FileVersion { get { return _fileVersionString.Value; }}
        public FileVersionInfo VersionInfo { get { return _fileVersionInfo.Value; }}
        ...
        private PEInfo(string filename) {
            ...
            _fileVersionString = new Lazy<string>(() => string.Format("{0}.{1}.{2}.{3}", _fileVersionInfo.Value.FileMajorPart, _fileVersionInfo.Value.FileMinorPart, _fileVersionInfo.Value.FileBuildPart, _fileVersionInfo.Value.FilePrivatePart));
            _fileVersionLong = new Lazy<ulong>(() => (((ulong)_fileVersionInfo.Value.FileMajorPart) << 48) + (((ulong)_fileVersionInfo.Value.FileMinorPart) << 32) + (((ulong)_fileVersionInfo.Value.FileBuildPart) << 16) + (ulong)_fileVersionInfo.Value.FilePrivatePart);
